...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6281265553098:+62 812-6555-3098\n' 
            + 'END:VCARD' 
blocked = []   
prefix = '#'
limitawal = 30
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6881265553098@s.whatsapp.net","6281265553098@s.whatsapp.net"] 
/************************************/
...
• Limit: ${limitawal-updated.limit}`
           ...
           case 'demote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`𝘆𝗮𝗵𝗵 @${mentioned[0].split('@')[0]} jabatan admin kamu telah dicopot🏃`, mentioned, true)
						client.groupDemoteAdmin(from, mentioned)
					}
					break
				case 'promote':
